// Script to fix all component availability based on transactions
import { query } from './config/db.js';

async function fixAllAvailability() {
  console.log('Starting to fix all component availability...');
  ...
  try {
    ...
    for (const component of components) {
      ...
      if (component.available_quantity !== correctAvailable) {
        console.log(`Fixing ${component.name}: ${component.available_quantity} -> ${correctAvailable} (issued: ${issued}, returned: ${returned}, damaged: ${damaged})`);
